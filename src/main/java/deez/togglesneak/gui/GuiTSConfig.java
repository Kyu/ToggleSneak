...
public class GuiTSConfig extends GuiScreen
{
	...
	{	
		...
		this.drawString(fontRenderer, lblFlyBoost,		this.width / 2 - 3 - this.fontRenderer.getStringWidth(lblFlyBoost),			getRowPos(6) + 6, 16777215);
		this.drawString(fontRenderer, lblFlyBoostAmount,	this.width / 2 - 3 - this.fontRenderer.getStringWidth(lblFlyBoostAmount),	getRowPos(7) + 6, 16777215);
